              ...
              @foreach ($brands as $row)
                ...
                <tr>
                 <td>{{ $i++ }}</td>
                  ...
                  <td>
                  <a href="{{ url('admin/brand/edit/'.$row->id) }}" class="btn btn-success">
                  <i class="fa fa-pencil"></i></a>
                  <a href="{{ url('admin/brand/delete/'.$row->id) }}" class="btn btn-danger">
                  <i class="fa fa-trash"></i></a>

                  @if($row->status == 1)

                  <a href="{{ url('admin/brand/inactive/'.$row->id) }}" class="btn btn-success">
                  <i class="fa fa-arrow-down"></i></a>
                  @else

                  <a href="{{ url('admin/brand/active/'.$row->id) }}" class="btn btn-success">
