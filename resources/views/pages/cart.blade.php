                                ...
                                <tr>
                                    ...
                                    <td class="shoping__cart__quantity">
                                        <div class="quantity">
                                            ...
                                            @csrf
                                            <div class="pro-qty">
                                                <input type="text" name="product_qty" value="{{ $cart->product_qty }}" min="1">
                                            </div>
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                       ...
                       @if (Session::has('coupon'))           
                            ...
                            <li>Coupon<span>{{ session()->get('coupon')['coupon_name'] }}
                            <a href="{{ url('coupon/destroy') }}">X</a> </span></li>
                            <li>Discount <span>{{ session()->get('coupon') 
                            ['coupon_discount'] }}%( {{ $discount = $subtotal * session()->get('coupon')
                            ['coupon_discount'] / 100 }} tk)</span></li>
                            <li>Total <span>${{ $subtotal - $discount }}</span></li>
                            @else
                            <li>Tototal <span>${{ $subtotal }}</span></li>
                            @endif
